                ...
                <main class="table" id="customers_table">
                    ...
                    <section class="table__body">
                        <table>
                            ...
                            <thead2>
                                <form action="mySaleOrder" method="GET">
                                    <tr>                              
                                        ...
                                        <th><input class="form-control mr-sm-2" aria-label="Search" placeholder="Tìm nội dung chuyển khoản" type="text" name="code" value="" /></th>
                            ...
                            <tbody>
                            <c:forEach items="${listRechargeUser}" var="listRecharge">
                                <tr>
                                    <td>${loop.index + 1}</td>
                                    <td>${listRecharge.status}</td>
                                    <td>${listRecharge.code}</td>
                                    <td>${listRecharge.fullname}</td>
                                    <td> <strong> ${listRecharge.moneyValue} </strong></td>
                                    <td> ${listRecharge.createdAt} </td>
                                    <td> ${listRecharge.updatedAt} </td>
                                    <td> 
                                        <button class="details-button" data-toggle="modal" data-target="#" data-orderId="${listRecharge.id}" data-userId="${listRecharge.uid}" data-moneyValue="${listRecharge.moneyValue}">
