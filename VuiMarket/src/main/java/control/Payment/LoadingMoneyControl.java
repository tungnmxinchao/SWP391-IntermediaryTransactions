 ...
 * @author pc
 */
public class LoadingMoneyControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (user != null) {
            String rechargeCode = Encode.rechargeCode();
            ...
            request.setAttribute("rechargeCode", rechargeCode);
            request.getRequestDispatcher("LoadingMoney.jsp").forward(request, response);
        } else {
