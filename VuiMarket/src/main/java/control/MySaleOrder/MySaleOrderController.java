 ...
 * @author TNO
 */
public class MySaleOrderController extends HttpServlet {
    ...
    private List<MySaleOrder> pagination(HttpServletRequest request, PageControl pageControl) {
        ...
        switch (action) {
            ...
            default:
                ...
                totalRecord = myOrderDAO.findTotalRecord(userId);

                listMySaleOrder = myOrderDAO.findByPage(page, userId);
                pageControl.setUrlPattern("mySaleOrder?");
