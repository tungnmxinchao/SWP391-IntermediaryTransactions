...
import dal.AdminHandling.AdminHandlingDAO;
import dal.DAO;
...
public class AdminHandling extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("AdminHandling.jsp").forward(request, response);
    }
    ...
    private List<MySaleOrder> pagination(HttpServletRequest request, PageControl pageControl) {
        ...
        AdminHandlingDAO adminHandlingDAO = new AdminHandlingDAO();
        HttpSession session = request.getSession();
        //valid page
        int page;
        try {
        ...
        switch (action) {
            ...
            case "category":
                break;
            default:
                totalRecord = adminHandlingDAO.findTotalRecord();

                listMySaleOrder = adminHandlingDAO.findByPage(page);
                pageControl.setUrlPattern("adminHandling?");
